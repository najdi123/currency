          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                {/* Name skeleton */}
                <div
                  className="h-5 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-3/4 mb-2 animate-shimmer"
                  style={{ backgroundSize: '1000px 100%' }}
                />
                {/* Price skeleton */}
                <div
                  className="h-8 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-full animate-shimmer"
                  style={{ backgroundSize: '1000px 100%' }}
                />
              </div>
            </div>
            ...
            <div
              className="h-8 w-16 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded-full animate-shimmer ml-2"
              style={{ backgroundSize: '1000px 100%' }}
            />
          </div>
        </div>
