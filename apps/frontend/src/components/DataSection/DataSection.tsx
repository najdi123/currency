...
export const DataSection = ({
  ...
  // Check if we have partial historical data
  const hasPartialData = isHistorical && completeness && completeness.percentage < 100
  ...
  return (
    ...
    >
      <div className=" pt-5">
        ...
        {hasPartialData && (
          <div className="mt-4 mx-3 sm:mx-6 lg:mx-8">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-yellow-700 dark:text-yellow-400 mt-1">
                    {t('partialDataDetails', {
                      available: completeness.successCount,
                      total: completeness.totalCount
                    })}
                  </p>
                </div>
              </div>
