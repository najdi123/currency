...
export class WalletsController {
  ...
  @ApiResponse({
    status: 403,
    description: "Forbidden - Can only access your own wallet",
  })
  ...
  @ApiOperation({
    summary: "Get transaction history by user ID (Admin or self)",
  })
  @ApiParam({
    name: "userId",
    description: "User ID",
  ...
  @ApiResponse({
    status: 403,
    description: "Forbidden - Admin role required or insufficient balance",
  })
