...
describe('AuthService', () => {
  ...
  describe('login', () => {
    it('should return token for valid credentials', async () => {
      ...
      refreshTokenModel.create.mockResolvedValue({ token: 'mock-refresh-token' });
      ...
      expect(usersService.setLastLogin).toHaveBeenCalledWith(mockUser._id.toString());
  ...
  describe('Refresh Token Operations', () => {
    ...
    describe('refreshAccessToken', () => {
      it('should return new access token and refresh token (rotation)', async () => {
        ...
        refreshTokenModel.create.mockResolvedValue({ token: 'new-refresh-token' });
        ...
        expect(refreshTokenModel.findByIdAndDelete).toHaveBeenCalledWith(tokenDoc._id);
      ...
      it('should throw UnauthorizedException for expired refresh token', async () => {
        ...
        expect(refreshTokenModel.findByIdAndDelete).toHaveBeenCalledWith(expiredTokenDoc._id);
      });
    ...
    describe('revokeRefreshToken', () => {
      it('should delete refresh token from database', async () => {
        ...
        expect(refreshTokenModel.deleteOne).toHaveBeenCalledWith({ token: refreshToken });
      });
      ...
      it('should throw error for non-existent token', async () => {
        ...
        await expect(service.revokeRefreshToken(nonExistentToken)).rejects.toThrow(
          'Invalid refresh token'
        );
      });
    });
