...
async function testSchemaStructure() {
  ...
  try {
    ...
    const TrackedItemModel = mongoose.model(
      "TrackedItem_Test",
      TrackedItemSchema,
    );
    ...
    const CurrentPriceModel = mongoose.model(
      "CurrentPrice_Test",
      CurrentPriceSchema,
    );
    ...
    logTest(
      ...
      {
        timeframe: historicalDoc.timeframe,
        dataPoints: historicalDoc.dataPoints,
      },
    );
  } catch (error: any) {
...
async function testIndexDefinitions() {
  ...
  try {
    ...
    const hasCompoundIndex = historicalIndexes.some(
      (idx: any) =>
...
async function testDocumentOperations() {
  ...
  try {
    ...
    logTest("HistoricalOhlc compound query structure", true, undefined, {
      query: compoundQuery,
    });
  } catch (error: any) {
