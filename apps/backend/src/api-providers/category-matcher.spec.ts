...
describe("CategoryMatcher", () => {
  ...
  describe("isCurrency", () => {
    it("should return true for exact currency category match", () => {
      ...
      expect(matcher.isCurrency(PersianAPICategory.CURRENCY_OFFICIAL)).toBe(
        true,
      );
      expect(matcher.isCurrency(PersianAPICategory.CURRENCY_SANA_BUY)).toBe(
        true,
      );
      expect(matcher.isCurrency(PersianAPICategory.CURRENCY_SANA_SELL)).toBe(
        true,
      );
      expect(matcher.isCurrency(PersianAPICategory.CURRENCY_NIMA_SELL)).toBe(
        true,
      );
    });
  ...
  describe("getItemType", () => {
    it('should return "currency" for currency categories', () => {
      expect(matcher.getItemType(PersianAPICategory.CURRENCY_FREE)).toBe(
        "currency",
      );
